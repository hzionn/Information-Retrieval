...
class VectorSpace:
    ...
    def getVectorKeywordIndex(self, documentList: list[str]) -> dict:
        ...
        #vocabularyList = vocabularyString.split() # this was for english
    ...
    def sort_out(self, documents: list[str], sample_news: list[str]):
        """
        sort document's size from biggest to smallest
        for the sake of efficiency

        param documents: original list that contain all of the documents string
        param sample_news: original list contain news order
        """
